...
async def on_message(message):
    ...
    if msg.startswith('!dong') or msg.startswith('!Dong'):
        ...
        await message.reply(
            f'DONG!! {user_name} has scored! {user_name} now has {dongs} dongs! Last dong was: {last_dong}'
        )
    ...
    if msg.startswith('!selfdong') or msg.startswith('!SelfDong'):
        ...
        await message.reply(
            f'SELFDONG!! {user_name} has been good to themself! {user_name} now has {dongs} selfdongs! Last selfdong was: {last_dong}'
        )
